<template>
  <div id="album" v-if="hotAlbums !== null">
    <div class="box" v-for="item in hotAlbums" :key="item.id">
      <div class="img">
      ...
      <div class="info">
        <h5>
          <a href="javascript:;" @click="toAlbumDetail(item.id)">{{
            item.name
          }}</a>
        </h5>
        <p>
    ...
    <!-- 翻页 -->
    <div class="juzhong" v-if="total !== null && total.total >= 30">
      <el-pagination
        background
